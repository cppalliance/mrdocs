...
Config::
+
.`override-see-below.yml`
[source,yaml]
----
include::example$snippets/extensions/override-see-below/override-see-below.yml[]
----

Section order::
+
.`addons/generator/common/partials/symbol.hbs`
[source,adoc-handlebars]
----
include::example$snippets/extensions/override-see-below/addons/generator/common/partials/symbol.hbs[]
----

Placeholder::
+
.`addons/generator/common/partials/symbol/signature/see-below.hbs`
[source,adoc-handlebars]
----
include::example$snippets/extensions/override-see-below/addons/generator/common/partials/symbol/signature/see-below.hbs[]
----

Input::
+
.`override-see-below.cpp`
[source,cpp]
----
include::example$snippets/extensions/override-see-below/override-see-below.cpp[]
----
======

The page then reads discussion-first and the elided synopsis points back up:

[.adoc-preview]
========
include::example$snippets/extensions/override-see-below/override-see-below.adoc[tags=!footer]
========
...
Mr.Docs registers the default helpers before any user code runs. They cover:
...
The xref:generators/reference.adoc[DOM reference] documents the values that helpers receive (symbol fields, document blocks, type nodes) so a helper knows what shape it is reading.
...
Either language works, and both see the same values. JavaScript gives you the ECMAScript built-ins but no module system, and Lua gives you its whole standard library and runs faster. The xref:extensions/script-engines.adoc[Script Engines] page compares the two in detail.
