...
The extension also bundles the https://en.cppreference.com[cppreference.com^] tagfile, so `std::*` names resolve there without extra configuration. Adding more tagfiles (Boost libraries, in-house projects) extends the macro to those targets.
