...
`never`: The strictest setting lists the base relationship but does not repeat the base's members on the derived page. This is the style used by https://en.cppreference.com[cppreference.com^]. Readers follow the link to the base to see what they inherited:
