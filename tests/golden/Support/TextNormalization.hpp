...
#ifndef MRDOCS_TEST_GOLDEN_SUPPORT_TEXTNORMALIZATION_HPP
#define MRDOCS_TEST_GOLDEN_SUPPORT_TEXTNORMALIZATION_HPP
...
#endif // MRDOCS_TEST_GOLDEN_SUPPORT_TEXTNORMALIZATION_HPP
