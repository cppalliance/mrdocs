...
Computes the integer square root stem:[\lfloor\sqrt{value}\rfloor]&period;

=== Synopsis

Declared in `&lt;sqrt&period;hpp&gt;`
...
This function calculates the square root of a given integral value using bit manipulation, in stem:[O(\log value)] time&period;
