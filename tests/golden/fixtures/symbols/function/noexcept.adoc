...
f6(
    T&,
    T&) noexcept(&sol;&ast; see-below &ast;&sol;);
----

=== Exception specification

This function is potentially-throwing unless `is&lowbar;nothrow&lowbar;move&lowbar;constructible&lowbar;v&lt;T&gt; &amp;&amp; is&lowbar;nothrow&lowbar;move&lowbar;assignable&lowbar;v&lt;T&gt;`.
