...
// Handlebars behavior tests: in-code BOOST_TEST checks only. No fixtures and
// no LLVM; this executable links only mrdocs::handlebars + test_suite.

namespace mrdocs {

struct Handlebars_unit_test
{
...
basic_context()
{
    ...
    // this keyword nested inside path
    {
        BOOST_TEST_THROW_WITH(
            ...
            handlebars::Error, "Invalid path: text/this - 1:2");
        ...
        BOOST_TEST_THROW_WITH(
            ...
            handlebars::Error, "Invalid path: text/this - 1:17");
...
partials()
{
    ...
    // failing dynamic partials
    {
        ...
        BOOST_TEST_THROW_WITH(
            hbs.render(str, hash),
            handlebars::Error, "The partial missing could not be found");
    }
    ...
    // rendering undefined partial throws an exception
    {
        BOOST_TEST_THROW_WITH(
            hbs.render("{{> whatever}}"),
            handlebars::Error, "The partial whatever could not be found");
    }
    ...
    // throw on missing partial
    {
        ...
        BOOST_TEST_THROW_WITH(
            ...
            handlebars::Error, "The partial dude could not be found");
    }
}
...
inline_partials()
{
    ...
    // should define inline partials for block
    {
        ...
        BOOST_TEST_THROW_WITH(
            ...
            handlebars::Error, "The partial myPartial could not be found");
    }
...
blocks()
{
    ...
    // block with complex lookup using nested context
    {
        ...
        BOOST_TEST_THROW_WITH(
            ...
            handlebars::Error, "Invalid path: foo/.. - 1:30");
    }
...
block_inverted_sections()
{
    ...
    // chained inverted sections with mismatch
    {
        BOOST_TEST_THROW_WITH(
            ...
            handlebars::Error, "people doesn't match if - 1:3");
    }
...
subexpressions()
{
    ...
    // provides each nested helper invocation its own options hash
    {
            ...
            dom::Value const& x, dom::Value const& y, dom::Value const& options)
        {
            ...
            {
                throw handlebars::Error("options hash was reused");
            }
            lastOptions = options;
            return x == y;
        });
...
builtin_each()
{
    ...
    // each on implicit context
    {
        ...
        BOOST_TEST_THROW_STARTS_WITH(
            ...
            handlebars::Error, "Must pass iterator to #each");
    }
}
...
helpers()
{
    ...
    // raw block parsing (with identity helper-function)
    {
        ...
        BOOST_TEST_THROW_WITH(
            hbs.render(string),
            handlebars::Error, "a missing closing braces - 1:4");
    }
    ...
    // String literal parameters
    {
        ...
        {
            BOOST_TEST_THROWS(
                hbs.render("Message: {{hello wo\"rld\"}}"), handlebars::Error);
        }
    ...
    // built-in helpers malformed arguments
    {
        ...
        {
            BOOST_TEST_THROW_STARTS_WITH(
                hbs.render("{{#if}}{{/if}}"), handlebars::Error, "#if requires exactly one argument");
        }

        // if helper - too many arguments, string
        {
            BOOST_TEST_THROW_STARTS_WITH(
                hbs.render("{{#if test \"string\"}}{{/if}}"), handlebars::Error, "#if requires exactly one argument");
        }

        // if helper - too many arguments, undefined
        {
            BOOST_TEST_THROW_STARTS_WITH(
                hbs.render("{{#if test undefined}}{{/if}}"), handlebars::Error, "#if requires exactly one argument");
        }

        // if helper - too many arguments, null
        {
            BOOST_TEST_THROW_STARTS_WITH(
                hbs.render("{{#if test null}}{{/if}}"), handlebars::Error, "#if requires exactly one argument");
        }

        // unless helper - too few arguments
        {
            BOOST_TEST_THROW_STARTS_WITH(
                hbs.render("{{#unless}}{{/unless}}"), handlebars::Error, "#unless requires exactly one argument");
        }

        // unless helper - too many arguments, null
        {
            BOOST_TEST_THROW_STARTS_WITH(
                hbs.render("{{#unless test null}}{{/unless}}"), handlebars::Error, "#unless requires exactly one argument");
        }

        // with helper - too few arguments
        {
            BOOST_TEST_THROW_STARTS_WITH(
                hbs.render("{{#with}}{{/with}}"), handlebars::Error, "#with requires exactly one argument");
        }

        // with helper - too many arguments
        {
            BOOST_TEST_THROW_STARTS_WITH(
                hbs.render("{{#with test \"string\"}}{{/with}}"), handlebars::Error, "#with requires exactly one argument");
        }
    }
...
strict()
{
    ...
    // should error on missing property lookup
    {
        BOOST_TEST_THROW_WITH(
            ...
            handlebars::Error, "\"hello\" not defined in [object Object] - 1:2");
    }
    ...
    // should error on missing child
    {
        ...
        BOOST_TEST_THROW_WITH(
            ...
            handlebars::Error, "\"bar\" not defined in [object Object] - 1:8");
    }
    ...
    // should error on missing data lookup
    {
        ...
        BOOST_TEST_THROW_WITH(
            ...
            handlebars::Error, "\"hello\" not defined in [object Object] - 1:3");
        dom::Object data;
        data.set("hello", "foo");
        opt.data = data;
    ...
    // should throw on ambiguous blocks
    {
        ...
        BOOST_TEST_THROW_WITH(
            ...
            handlebars::Error, "\"bar\" not defined in [object Object] - 1:9");
    }
    ...
    // should show error location on missing property lookup
    {
        ...
        BOOST_TEST_THROW_WITH(
            hbs.render(string, dom::Object{}, opt),
            handlebars::Error, "\"hello\" not defined in [object Object] - 4:5");
    }
}
...
assume_objects()
{
    ...
    // should error on missing context
    {
        ...
        BOOST_TEST_THROW_WITH(
            ...
            handlebars::Error, "\"hello\" not defined in null - 1:2");
    }
...
TEST_SUITE(
    Handlebars_unit_test,
    "clang.mrdocs.handlebars.unit");
