...
const scopeRules: ScopeRule[] = [
    { scope: "golden-tests", patterns: [/^tests\/golden\/fixtures\//i] },
    {
        scope: "tests",
        patterns: [
            /^tests\/unit\//i,
    ...
    {
        scope: "source",
        patterns: [/^src\//i, /^include\//i, /^libs\//i, /^tools\//i, /^data\//i, /^SourceFileNames\.cpp$/i],
    },
    { scope: "docs", patterns: [/^docs\//i, /^README\.adoc$/i] },
    ...
    { scope: "toolchain-tests", patterns: [/^utils\/bootstrap\/tests\//i] },
    {
        scope: "toolchain",
        patterns: [
            /^bootstrap\.py$/i,
    ...
    { scope: "tooling", patterns: [/^utils\/(?!danger\/)/i] },
    { scope: "tooling", patterns: [/^\.clang-format$/i] },
    { scope: "ci", patterns: [/^utils\/danger\//i, /^\.github\//, /^\.roadmap\//] },
