...
class MrDocsInstaller:
    ...
    def __init__(self, cmd_line_args: Optional[Dict[str, Any]] = None, source_dir: Optional[str] = None):
        ...
        # Paths
        self.recipes_dir = os.path.join(self.options.source_dir, "utils", "bootstrap", "recipes")
        self.patches_dir = os.path.join(self.options.source_dir, "utils", "bootstrap", "patches")
