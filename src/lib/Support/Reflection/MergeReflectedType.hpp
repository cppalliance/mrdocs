...
#ifndef MRDOCS_LIB_SUPPORT_REFLECTION_MERGEREFLECTEDTYPE_HPP
#define MRDOCS_LIB_SUPPORT_REFLECTION_MERGEREFLECTEDTYPE_HPP
...
// translation units that instantiate mergeReflected.
class SymbolID;
struct Type;
struct Name;
...
/** Check if a Polymorphic\<Type\> is in a placeholder state.
    ...
    Defined in Reflection.cpp to avoid including heavy Type headers.
*/
MRDOCS_DECL
bool
