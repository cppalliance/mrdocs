...
auto
overloadFunctionsRange(OverloadsSymbol const& O, Corpus& corpus_)
{
...
template <class Range>
void
populateOverloadsBrief(OverloadsSymbol& I, Range&& functions, Config const& config)
{
    ...
    if (!config.autoFunctionMetadata &&
        !anyMemberBrief)
    {
