...
bool
populateFunctionBriefFromClass(FunctionSymbol& I, Corpus const& corpus)
{
    switch (I.FuncClass)
    {
...
void
populateFunctionBrief(FunctionSymbol& I, Corpus const& corpus)
{
...
void
populateFunctionReturns(FunctionSymbol& I, Corpus const& corpus)
{
...
void
populateFunctionParams(FunctionSymbol& I, Corpus const& corpus)
{
