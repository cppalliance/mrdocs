...
public:
    ...
    */
    ...
    /** Get the set of extracted Info declarations.
        ...
        @return A reference to the detail::SymbolSet containing the extracted Info declarations.
    */
    detail::SymbolSet&
    results()
    {
...
private:
    ...
    */
    ...
    /*  Get Info from ASTVisitor detail::SymbolSet
     */
    Symbol*
    ...
    /*  Find or traverse a declaration
        ...
        object for a declaration in the detail::SymbolSet.
