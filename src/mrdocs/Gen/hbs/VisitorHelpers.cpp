 ...
 */
Symbol const*
findPrimarySiblingWithUrl(Corpus const& c, Config const& config, Symbol const& I, Symbol const& parent)
{
...
Symbol const*
findPrimarySiblingWithUrl(Corpus const& c, Config const& config, Symbol const& I);
 ...
 */
Symbol const*
findDirectPrimarySiblingWithUrl(Corpus const& c, Config const& config, Symbol const& I)
{
    ...
    MRDOCS_CHECK_OR(parent, nullptr);
    if (!shouldGenerate(*parent, config))
    {
        parent = findPrimarySiblingWithUrl(c, config, *parent);
        MRDOCS_CHECK_OR(parent, nullptr);
    }
    return findPrimarySiblingWithUrl(c, config, I, *parent);
}
 ...
 */
Symbol const*
findResolvedPrimarySiblingWithUrl(Corpus const& c, Config const& config, Symbol const& I)
{
...
findPrimarySiblingWithUrl(Corpus const& c, Config const& config, Symbol const& I)
{
    if (Symbol const* primary = findDirectPrimarySiblingWithUrl(c, config, I))
    {
        return primary;
    }
    return findResolvedPrimarySiblingWithUrl(c, config, I);
}
 ...
 */
Symbol const*
findParentWithUrl(Corpus const& c, Config const& config, Symbol const& I)
{
    Symbol const* parent = c.find(I.Parent);
    MRDOCS_CHECK_OR(parent, nullptr);
...
Symbol const*
findAlternativeURLInfo(Corpus const& c, Config const& config, Symbol const& I)
{
    if (Symbol const* primary = findPrimarySiblingWithUrl(c, config, I))
    {
        return primary;
    }
    return findParentWithUrl(c, config, I);
}
