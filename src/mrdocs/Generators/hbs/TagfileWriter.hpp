...
#ifndef MRDOCS_LIB_GENERATORS_HBS_TAGFILEWRITER_HPP
#define MRDOCS_LIB_GENERATORS_HBS_TAGFILEWRITER_HPP

#include <mrdocs/Generators/xml/XMLTags.hpp>
...
#endif // MRDOCS_LIB_GENERATORS_HBS_TAGFILEWRITER_HPP