...
#ifndef MRDOCS_LIB_GENERATORS_HBS_HANDLEBARSGENERATOR_HPP
#define MRDOCS_LIB_GENERATORS_HBS_HANDLEBARSGENERATOR_HPP
...
namespace handlebars { class OutputRef; }
...
public:
    ...
    */
    virtual
    void
    escape(handlebars::OutputRef& os, std::string_view str) const;
...
private:
    ...
    Expected<void>
    renderSinglePage(std::ostream& os, Corpus const& corpus, Config const& config) const;
};
