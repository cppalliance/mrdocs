...
struct ErrorCodeAccessHack;

}
}

template<>
struct llvm::Expected<clang::mrdox::ErrorCodeAccessHack>
{
  static llvm::ErrorInfoBase const* getPtr(llvm::Error const& e)
  {
    return e.getPtr();
  }
};
...
class ErrorCode
{
    ...
    {
        return llvm::Expected<ErrorCodeAccessHack>::getPtr(e);
    }
